...
export default function Page() {
    return (
        <section className="mt-20">
            <div className={`max-w-5xl mx-auto flex flex-col gap-4 py-20 ${geistSans.className}`}>

            <h1 className="font-semibold text-7xl tracking-tighter text-center"><TextBlurFade text="Contact Us" spaceSplitting={false} /></h1>
...
function ContactCard() {
    return (
        <div className={`flex flex-col md:flex-row gap-4 shadow-lg bg-white transition-all rounded-3xl px-10 py-12 border border-zinc-200 ${geistSans.className}`}>
            ...
            <div className="flex flex-col gap-3 w-1/2">
                <h1 className="text-5xl tracking-tight font-medium pb-5">Get In Touch</h1>
                <div className="flex flex-row gap-3">
                    <input type="text" placeholder="Name" className="rounded-md bg-zinc-200 p-2"/>
                    <input type="text" placeholder="Email" className="rounded-md bg-zinc-200 p-2"/>
                </div>
                <textarea placeholder="Message" className="rounded-md bg-zinc-200 p-2  flex-1" />
                <button className="hidden md:flex shadow-md hover:shadow-lg items-center justify-center bg-white transition-all cursor-pointer rounded-xl px-3 py-2 border border-zinc-200 font-semibold ">Submit</button>
            </div>
        </div>
    )
}