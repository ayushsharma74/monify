...
export default function HeroSection() {
  ...
  return (
    <section>
      ...
      <div className="absolute top-6/8 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-zinc-100 gap-3 items-center p-1 rounded-xl font-semibold text-zinc-500 text-sm tracking-tight hidden lg:flex">
