...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between px-4 md:px-12 lg:px-18 py-4 items-center 
    bg-white/10 backdrop-blur-md ">
      ...
      <button className="hidden md:flex shadow-md hover:shadow-lg bg-white transition-all cursor-pointer rounded-xl px-4 py-3 border border-zinc-200 font-semibold">Get Started</button>
    </nav>
  )
}